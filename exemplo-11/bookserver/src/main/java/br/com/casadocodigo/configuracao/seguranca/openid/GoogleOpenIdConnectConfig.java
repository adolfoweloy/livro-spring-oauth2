...
public class GoogleOpenIdConnectConfig {
    ...
    public OAuth2ProtectedResourceDetails protectedResourceDetails() {
        ClientOnlyAuthorizationCodeResourceDetails details = new ClientOnlyAuthorizationCodeResourceDetails();
    ...
    private static class ClientOnlyAuthorizationCodeResourceDetails
